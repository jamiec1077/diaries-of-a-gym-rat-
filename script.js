$(function () {
   ...
   // as time goes from past,present,future the time block should change color 
    $(".past").find(".description").css("background-color", "#ffffb3");
    $(".present").find(".description").css("background-color", "#ffccff");
    $(".future").find(".description").css("background-color", "#ffffcc");
